 ...
 */
export function StatCard({ label, value, color = 'text-gray-900', hint, onClick }) {
    return (<div onClick={onClick} class={`bg-white rounded-2xl shadow-card p-5 transition-all hover:-translate-y-0.5 hover:shadow-card-hover ${onClick ? 'cursor-pointer' : ''}`}>
